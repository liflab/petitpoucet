 ...
 */
public class Clause implements Set<PartVertex>
{
	/**
	 * The parts.
	 */
	protected final Set<PartVertex> m_parts;
	 ...
	 */
	public Clause(PartVertex ... nodes)
	{
		super();
		m_parts = new MathSet<>();
		for (PartVertex pn : nodes)
		{
			m_parts.add(pn);
		}
	}
	...
	@Override
	public void forEach(Consumer<? super PartVertex> action)
	{
	...
	@Override
	public Iterator<PartVertex> iterator()
	{
	...
	@Override
	public boolean add(PartVertex e)
	{
	...
	@Override
	public boolean addAll(Collection<? extends PartVertex> c)
	{
	...
	@Override
	public boolean removeIf(Predicate<? super PartVertex> filter)
	{
	...
	@Override
	public Spliterator<PartVertex> spliterator()
	{
