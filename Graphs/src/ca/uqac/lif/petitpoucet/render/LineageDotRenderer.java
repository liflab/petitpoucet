...
public class LineageDotRenderer implements Renderer
{
	 ...
	 */
	/*@ non_null @*/ protected List<Vertex> m_roots;

	/**
	 * A map associating node instances to their uniquely generated ID.
	 */
	/*@ non_null @*/ protected Map<Vertex,String> m_nodeIds;
	 ...
	 */
	/*@ non_null @*/ protected Set<Vertex> m_rendered;
	 ...
	 */
	/*@ non_null @*/ protected List<Vertex> m_leaves;
	 ...
	 */
	public LineageDotRenderer(/*@ non_null @*/ List<? extends Vertex> roots, /*@ non_null @*/ String prefix, int nesting_level, boolean no_captions)
	{
		super();
		m_idCounter = 0;
	 ...
	 * are typically the roots of a directed acyclic graph.
	 */
	public LineageDotRenderer(/*@ non_null @*/ List<? extends Vertex> roots)
	{
		this(roots, "", 0, false);
	}
	 ...
	 */
	protected void render(PrintStream ps, Vertex current)
	{
	 ...
	 * @param current The node to render
	 */
	protected void renderNode(PrintStream ps, Vertex current)
	{
		...
		{
			renderOrNode(ps, (OrVertex) current, n_id);
		}
		else if (current instanceof AndVertex)
		{
			renderAndNode(ps, (AndVertex) current, n_id);
		}
		else if (current instanceof PartVertex)
		{
	 ...
	 */
	protected void renderPartNode(PrintStream ps, PartVertex current, String n_id)
	{
