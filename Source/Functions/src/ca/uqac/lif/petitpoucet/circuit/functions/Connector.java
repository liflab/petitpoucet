...
{
  public static void connect(CircuitFunction f1, int output_index, CircuitFunction f2, int input_index)
  {
  ...
  public static void connect(CircuitFunction f1, CircuitFunction f2)
  {
    connect(f1, 0, f2, 0);
  }
}
