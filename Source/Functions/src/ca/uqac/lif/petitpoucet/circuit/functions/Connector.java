...
{
  public static void connect(SingleFunction f1, int output_index, SingleFunction f2, int input_index)
  {
  ...
  public static void connect(SingleFunction f1, SingleFunction f2)
  {
    connect(f1, 0, f2, 0);
  }
}
