 ...
 * existential quantification on a collection of elements.
 * 
 * @author Sylvain Hallé
 */
public class SomeObject extends BooleanObjectQuantifier
{
	/**
	...
	{
		if (Boolean.FALSE.equals(m_verdict))
		{
			return f.getAndNode();
		}
		return f.getOrNode();
	...
	{
		return new SomeObject(m_condition);
	}
