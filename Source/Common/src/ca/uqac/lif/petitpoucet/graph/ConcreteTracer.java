...
public class ConcreteTracer implements Tracer
{
	 ...
	 * 
	 * @param b
	 *          <tt>true</tt> to simplify (default), <tt>false</tt> otherwise
	 * @return This tracer
	 */
	 ...
	 * 
	 * @param q
	 *          The type of traceability query
	 * @param d
	 *          The designator indicating the part of the object this query is about
	 * @param o
	 *          The target object
	 * @return A node representing the root of the traceability tree
	 */
	/* @ non_null @ */ public ConcreteObjectNode getTree(TraceabilityQuery q,
			/* @ non_null @ */ Designator d, /* @ non_null @ */ Object o)
	{
	...
	/* @ non_null @ */ protected void getChildren(TraceabilityQuery q,
			/* @ non_null @ */ ConcreteTraceabilityNode root,
			/* @ non_null @ */ Set<ConcreteTraceabilityNode> visited)
	{
