...
public abstract class Lists
{
	protected static abstract class LazyAllElementsVertex extends LazyVertex
	{
		...
		protected abstract AtomicFunction getInstance();
	 ...
	 */
	public static class ElementAt extends AtomicFunction
	{
		/**
		...
		{
			ElementAt e = new ElementAt(m_index);
			duplicate(e, with_state);
			return e;
		}
	...
	public static class SumAll extends AtomicFunction
	{
		public SumAll()
		{
			super(1, 1);
		...
		protected class LazySumAllVertex extends LazyAllElementsVertex
		{
			...
			@Override
			protected AtomicFunction getInstance()
			{
				return SumAll.this;
			}
	...
	public static class Window extends ParameterizedFunction
	{
		/**
		 ...
		 */
		public Window(int width, CompositeFunction f)
		{
			super(1, 1, f);
			m_width = width;
		}
		...
		protected class WindowLazyVertex extends ParameterizedFunctionVertex
		{ 
	 ...
	 */
	public static class Apply extends ParameterizedFunction
	{
		/**
		 * Creates a new instance of the function.
		 * @param f The function to apply to each element of the list
		 */
		public Apply(/*@ non_null @*/ CompositeFunction f)
		{
			super(1, 1, f);
		...
		{
			Apply a = new Apply(m_f.duplicate(with_state));
		...
		protected class ApplyLazyVertex extends ParameterizedFunctionVertex
		{
			...
			@Override
			public ParameterizedFunction getInstance()
			{
				return Apply.this;
			}
