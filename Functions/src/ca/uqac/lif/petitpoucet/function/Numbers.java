 ...
 */
public abstract class Numbers<T> extends AtomicFunction
{
	/**
	...
	public static class Multiplication extends Numbers<Float>
	{
		...
		{
			Multiplication m = new Multiplication(getInputArity());
			duplicate(m, with_state);
			return m;
		}
