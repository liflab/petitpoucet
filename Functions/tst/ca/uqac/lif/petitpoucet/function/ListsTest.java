...
import ca.uqac.lif.petitpoucet.function.Lists.Apply;
import ca.uqac.lif.petitpoucet.function.Lists.ElementAt;
import ca.uqac.lif.petitpoucet.function.Lists.NthElement;
...
public class ListsTest
{
	...
	public void testApply1()
	{
		...
		CompositeFunction c = getCircuit(d);
		Apply f = new Apply(c);
	...
	public void testApplyExplain1() throws ExplanationException
	{
		IdentityVertexFactory factory = new IdentityVertexFactory();
		Numbers.Double d = new Numbers.Double();
		CompositeFunction c = getCircuit(d, "CDouble");
		Apply f = new Apply(c);
		connect(new Constant(Arrays.asList(1, 2, 3)), 0, f, 0);
		f.compute();
	...
	public void testWindow1()
	{
		...
		CompositeFunction c = getCircuit(mul);
	...
	public void testWindowExplain1() throws ExplanationException
	{
		...
		CompositeFunction c = getCircuit(d, "InWin");
		Window f = new Window(3, c);
	...
	protected static CompositeFunction getCircuit(AtomicFunction n)
	{
		return getCircuit(n, null);
	}

	protected static CompositeFunction getCircuit(AtomicFunction n, String name)
	{
		CompositeFunction c = new CompositeFunction(n.getInputArity(), n.getOutputArity(), name);
		c.add(n);
