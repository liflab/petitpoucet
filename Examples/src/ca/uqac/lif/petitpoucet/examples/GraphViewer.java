 ...
 */
package ca.uqac.lif.petitpoucet.examples;
...
public class GraphViewer
{
	 ...
	 * @throws IOException If the file operation did not succeed
	 */
	public static void save(Vertex root, String filename, boolean no_captions) throws IOException
	{
	 ...
	 * @throws IOException If the file operation did not succeed
	 */
	public static void save(List<Vertex> roots, String filename) throws IOException
	{
